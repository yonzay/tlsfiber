...
<p align="center">
  <b>Fiber</b>是一个�?�到<a href="https://github.com/expressjs/express">Express</a>�?��?�的<b>Web框架</b>，建立在<a href="https://golang.org/doc/">Go</a>语言写的<b>最快的</b><a href="https://github.com/valyala/fasthttp">Fasthttp</a>HTTP引擎的基础上。旨在<b>简化</b> <b>零内存分�?</b>和<b>�??高性能</b>，以便<b>快速</b>开�?�。
</p>
...
这些测试由[TechEmpower](https://www.techempower.com/benchmarks/#section=data-r19&hw=ph&test=plaintext)和[Go Web](https://github.com/smallnest/go-web-framework-benchmark) 执行。如果�?查看所有结果，请访问我们的[Wiki](https://docs.gofiber.io/benchmarks) 。
...
## ⚙�? 安装
确�?已安装 ([下载](https://golang.org/dl/)) `1.14` 或更高版本的 Go。

通过创建文件夹并在文件夹内�?行 `go mod init github.com/your/repo` ([了解更多](https://blog.golang.org/using-go-modules)) �?��?始化项目，然�?�使用 [`go get`](https://golang.org/cmd/go/#hdr-Add_dependencies_to_current_module_and_install_them) 命令安装 Fiber：
...
-   [�?��?文件](https://docs.gofiber.io/application#static)�?务
-   �?�?[表现](https://docs.gofiber.io/benchmarks)
-   [内存�?�用低](https://docs.gofiber.io/benchmarks)
-   [API 接�?�](https://docs.gofiber.io/context)
-   [中间件](https://docs.gofiber.io/middleware)和[Next](https://docs.gofiber.io/context#next)支�?
-   [快速](https://dev.to/koddr/welcome-to-fiber-an-express-js-styled-fastest-web-framework-written-with-on-golang-497)�?务器端编程
-   [模版引擎](https://github.com/gofiber/template)
-   [WebSocket 支�?](https://github.com/gofiber/websocket)
-   [频率�?制器](https://docs.gofiber.io/middleware#limiter)
-   [15 �?语言](https://docs.gofiber.io/)
-   以�?�更多请[探索文档](https://docs.gofiber.io/)

## 💡 哲学

从[Node.js](https://nodejs.org/en/about/)切�?�到[Go](https://golang.org/doc/)的新`gopher`在开始构建`Web`应用程�?或微�?务之�?正在应对学习曲线。 `Fiber`作为一个**Web 框架** ，是按照**�?简主义**的�?想并�?�循**UNIX 方�?**创建的，因此新的`gopher`�?�以在热烈和�?�信赖的欢迎中迅速进入`Go`的世界。

`Fiber`�?�到了互�?�网上最�?行的`Web`框架`Express`的**�?��?�** 。我们结�?�了`Express`的**易用性**和`Go`的**原始性能** 。如果您曾�?在`Node.js`上实现过`Web`应用程�?(_使用 Express 或类似工具_)，那么许多方法和原�?�对您�?�说应该**�?�常易懂**。

我们**关注** _整个互�?�网_ 用户在[issues](https://github.com/gofiber/fiber/issues)和 Discord [channel](https://gofiber.io/discord)的消�?�，为了创建一个**迅速**，**�?�活**以�?�**�?�好**的`Go web`框架，满足**任何**任务，**最�?�期�?**和开�?�者**技能**。就�?`Express`在`JavaScript`世界中一样。

## 👀 示例

下�?�列出了一些常�?示例。如果您想查看更多代�?示例，请访问我们的[Recipes](https://github.com/gofiber/recipes)代�?库或[API 文档](https://docs.gofiber.io) 。
...
<details>
  <summary>📚 展示更多代�?示例</summary>

### 模版引擎

📖 [�?置](https://docs.gofiber.io/fiber#config)
📖 [模版引擎](https://github.com/gofiber/template)
📖 [渲染](https://docs.gofiber.io/context#render)

如果未设置模版引擎，则`Fiber`默认使用[html/template](https://golang.org/pkg/html/template/)。

如果您�?执行部分模版或使用其他引擎，例如[amber](https://github.com/eknkc/amber)，[handlebars](https://github.com/aymerick/raymond)，[mustache](https://github.com/cbroglie/mustache)或者[pug](https://github.com/Joker/jade)等等...

请查看我们的[Template](https://github.com/gofiber/template)包，该包支�?多个模版引擎。
...
通过在请求头中设置`Origin`传递任何域�?�检查 CORS：
...
如果您�?说声**谢谢**或支�?`Fiber`的积�?�?�展：

1. 为`Fiber`[GitHub Star](https://github.com/gofiber/fiber/stargazers)点个 �? 星星。
2. 在[Twitter](https://twitter.com/intent/tweet?text=Fiber%20is%20an%20Express%20inspired%20%23web%20%23framework%20built%20on%20top%20of%20Fasthttp%2C%20the%20fastest%20HTTP%20engine%20for%20%23Go.%20Designed%20to%20ease%20things%20up%20for%20%23fast%20development%20with%20zero%20memory%20allocation%20and%20%23performance%20in%20mind%20%F0%9F%9A%80%20https%3A%2F%2Fgithub.com%2Fgofiber%2Ffiber)上�?�布有关项目的[推文](https://twitter.com/intent/tweet?text=Fiber%20is%20an%20Express%20inspired%20%23web%20%23framework%20built%20on%20top%20of%20Fasthttp%2C%20the%20fastest%20HTTP%20engine%20for%20%23Go.%20Designed%20to%20ease%20things%20up%20for%20%23fast%20development%20with%20zero%20memory%20allocation%20and%20%23performance%20in%20mind%20%F0%9F%9A%80%20https%3A%2F%2Fgithub.com%2Fgofiber%2Ffiber)。
3. 在[Medium](https://medium.com/)，[Dev.to](https://dev.to/)或个人�?�客上写评论或教程。
4. 通过�??赠[一�?�咖啡](https://buymeacoff.ee/fenny)�?�支�?本项目。

## ☕ 支�?者

`Fibre`是一个开�?项目，�?�?��??赠�?�支付账�?�，例如我们的域�??，`gitbook`，`netlify`和无�?务器托管。如果�?支�?`Fiber`，�?�以 ☕ [**在这里买一�?�咖啡**](https://buymeacoff.ee/fenny)
