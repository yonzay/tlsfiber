...
<b>Fiber</b> הי�? <b>web framework</b> בהשר�?ת <a href="https://github.com/expressjs/express">Express</a> הבנויה על גבי <a href="https://github.com/valyala/fasthttp">Fasthttp</a>, מנוע ה-HTTP <b>המהיר ביותר</b> עבור <a href="https://golang.org/doc/">Go</a>.
נועדה <b>להקל</b> על הענייני�? למען פיתוח <b>מהיר</b>, <b>לל�? הקצ�?ות זכרון</b> ולוקחת <b>ביצועי�?</b> בחשבון.
...
הבדיקות מבוצעות על ידי [TechEmpower](https://www.techempower.com/benchmarks/#section=data-r19&hw=ph&test=plaintext) ו-[Go Web](https://github.com/smallnest/go-web-framework-benchmark). �?�? �?ת�? רוצי�? לר�?ות �?ת כל התוצ�?ות, �?נ�? בקרו ב-[Wiki](https://docs.gofiber.io/benchmarks) שלנו.
...
-   הנגשת [קבצי�? סטטיי�?](https://docs.gofiber.io/application#static)
-   [ביצועי�?](https://docs.gofiber.io/benchmarks) גבוהי�? במיוחד
...
-   [הגבלת קצבי�? ובקשות](https://docs.gofiber.io/middleware#limiter)
-   Available in [12 languages](https://docs.gofiber.io/)
-   והרבה יותר, [חקור �?ת Fiber](https://docs.gofiber.io/)
</div>
...
gophers חדשי�? שעושי�? �?ת המעבר מ-[Node.js](https://nodejs.org/en/about/) ל-[Go](https://golang.org/doc/) מתמודדי�? ע�? עקומת למידה לפני שה�? יכולי�? להתחיל לבנות �?ת יישומי ה�?ינטרנט �?ו המיקרו-שירותי�? שלה�?.
Fiber כ-**web framework**, נוצרה ע�? רעיון **המינימליז�?** ועוקבת �?חרי **הדרך של UNIX**, כך ש-gophers חדשי�? יוכלו להיכנס במהירות לעול�? של Go ע�? קבלת פני�? חמה ו�?מינה.

</div>

<div dir="rtl">

Fiber נוצרה **בהשר�?ת** Express, ה-web framework הפופולרית ביותר ברחבי ה�?ינטרנט. שילבנו �?ת **הקלות** של Express ו**הביצועי�? הגולמיי�?** של Go. �?�? �?י-פע�? מימשת�? יישו�? web ב-Node.js (_ב�?מצעות Express �?ו דומיו_), �?ז הרבה מהפונקציות והעקרונות ייר�?ו לכ�? **מ�?וד מוכרי�?**.

</div>

<div dir="rtl">

�?נחנו **מקשיבי�?** למשתמשי�? שלנו ב-[issues](https://github.com/gofiber/fiber/issues) (_ובכל רחבי ה�?ינטרנט_) כדי ליצור web framework **מהירה**, **גמישה**, ו**ידידותית** בשפת Go עבור **כל** משימה, **ת�?ריך יעד** ו**כישורי** מפתח! בדיוק כמו ש-Express מבצע בעול�? של JavaScript.
...
להלן כמה מהדוגמ�?ות הנפוצות. �?�? ברצונכ�? לר�?ות דוגמ�?ות קוד נוספות, �?נ�? בקרו ב[מ�?גר המתכוני�?](https://github.com/gofiber/recipes) שלנו �?ו בקרו ב[תיעוד ה-API](https://docs.gofiber.io) שלנו.
...
<div dir="rtl">
<details>
  <summary>📚 הצג דוגמ�?ות קוד נוספות</summary>
...
בדוק �?ת ה-CORS על ידי העברת כל domain ב-header של <span dir="ltr">`Origin`</span>:
...
### Middleware של הת�?וששות

📖 [הת�?וששות](https://docs.gofiber.io/middleware/recover)
...
�?�? �?ת�? רוצי�? לומר **תודה** �?ו/ו לתמוך בפיתוח הפעיל של <span dir="ltr">`Fiber`</span>:
...
2. צייצו לגבי הפרויקט [בטוויטר שלכ�?](https://twitter.com/intent/tweet?text=Fiber%20is%20an%20Express%20inspired%20%23web%20%23framework%20built%20on%20top%20of%20Fasthttp%2C%20the%20fastest%20HTTP%20engine%20for%20%23Go.%20Designed%20to%20ease%20things%20up%20for%20%23fast%20development%20with%20zero%20memory%20allocation%20and%20%23performance%20in%20mind%20%F0%9F%9A%80%20https%3A%2F%2Fgithub.com%2Fgofiber%2Ffiber).
3. כתבו ביקורת �?ו מדריך ב-[Medium](https://medium.com/), [Dev.to](https://dev.to/) �?ו בבלוג ה�?ישי שלכ�?.
...
Fiber הי�? פרויקט קוד פתוח שתשלו�? חשובונתיו מסתמך על תרומות, כגון ש�? ה-domain שלנו, gitbook, netlify ו-serverless hosting. �?�? �?ת�? רוצי�? לתמוך ב-Fiber, �?ת�? יכולי�? ☕ [**קנו קפה כ�?ן**](https://buymeacoff.ee/fenny).
