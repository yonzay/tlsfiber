...
<p align="center">
  <strong>Fiber</strong> — �?то <strong>веб фреймворк</strong>, который был вдохновлен <a href="https://github.com/expressjs/express">Express</a> и о�?нован на <a href="https://github.com/valyala/fasthttp">Fasthttp</a>, �?амом бы�?тром HTTP-движке напи�?анном на <a href="https://golang.org/doc/">Go</a>. Фреймворк был разработан �? целью <strong>упро�?тить</strong> проце�?�? <strong>бы�?трой</strong> разработки <strong>вы�?окопроизводительных</strong> веб-приложений �? <strong>нулевым ра�?пределением пам�?ти</strong>.
</p>
...
Те�?тирование проводило�?ь �? помощью [TechEmpower](https://www.techempower.com/benchmarks/#section=data-r19&hw=ph&test=plaintext) и [Go Web](https://github.com/smallnest/go-web-framework-benchmark). Е�?ли вы хотите увидеть в�?е результаты, пожалуй�?та, по�?етите наш [Wiki](https://docs.gofiber.io/benchmarks).
...
Убедите�?ь, что Go у�?тановлен ([�?качать](https://golang.org/dl/)). Требует�?�? вер�?и�? `1.14` или выше. 

Инициализируйте проект, �?оздав папку, а затем запу�?тив `go mod init github.com/your/repo` ([подробнее](https://blog.golang.org/using-go-modules)) внутри �?той папки. Далее, у�?тановите Fiber �? помощью команды [`go get`](https://golang.org/cmd/go/#hdr-Add_dependencies_to_current_module_and_install_them):
...
-   �?адежна�? [маршрутизаци�?](https://docs.gofiber.io/routing)
-   До�?туп к [�?татичным файлам](https://docs.gofiber.io/application#static)
-   Эк�?тремальна�? [производительно�?ть](https://docs.gofiber.io/benchmarks)
-   [�?изкий объем потреблени�? пам�?ти](https://docs.gofiber.io/benchmarks)
...
-   [Бы�?трое](https://dev.to/koddr/welcome-to-fiber-an-express-js-styled-fastest-web-framework-written-with-on-golang-497) программирование на �?тороне �?ервера
-   [Template engines](https://github.com/gofiber/template)
-   [Поддержка WebSocket](https://github.com/gofiber/websocket)
-   [Rate Limiter](https://docs.gofiber.io/middleware#limiter)
-   Документаци�? до�?тупна на [15 �?зыках](https://docs.gofiber.io/)
-   И многое другое, [по�?етите наш Wiki](https://docs.gofiber.io/)

## 💡 Фило�?офи�?

�?овые Go-программи�?ты, которые переключают�?�? �? [Node.js](https://nodejs.org/en/about/) на [Go](https://golang.org/doc/), имеют дело �? очень извили�?той кривой обучени�?, прежде чем они �?могут начать �?оздавать �?вои веб-приложени�? или микро�?ерви�?ы. Fiber, как **веб-фреймворк**, был �?оздан �? идеей **минимализма** и �?ледовал **принципу UNIX**, так что новички �?могут бы�?тро войти в мир Go без о�?обых проблем.

Fiber **вдохновлен** Express, �?амым попул�?рным веб фреймворком в Интернете. Мы объединили **про�?тоту** Express и **чи�?тую производительно�?ть** Go. Е�?ли вы когда-либо реализовывали веб-приложение на Node.js (_�? и�?пользованием Express или аналогичного фреймворка_), то многие методы и принципы покажут�?�? вам **очень знакомыми**.

Мы **при�?лушиваем�?�?** к нашим пользовател�?м в [issues](https://github.com/gofiber/fiber/issues), Discord [канале](https://gofiber.io/discord) _и в о�?тальном Интернете_, чтобы �?оздать **бы�?трый**, **гибкий** и **дружелюбный** веб фреймворк на Go дл�? **любых** задач, **дедлайнов** и **уровней** разработчиков! Как �?то делает Express в мире JavaScript.

## 👀 Примеры

�?иже перечи�?лены некоторые из ра�?про�?траненных примеров. Е�?ли вы хотите увидеть больше примеров кода, пожалуй�?та, по�?етите наш [репозиторий рецептов](https://github.com/gofiber/recipes) или [документацию по API](https://docs.gofiber.io).
...
Е�?ли не указано ни одного движка дл�? views, Fiber и�?пользует [html/template](https://golang.org/pkg/html/template/).

Вы можете и�?пользовать движки [amber](https://github.com/eknkc/amber), [handlebars](https://github.com/aymerick/raymond), [mustache](https://github.com/cbroglie/mustache) или [pug](https://github.com/Joker/jade) и другие...

Ознакомьте�?ь �? пакетом [Template](https://github.com/gofiber/template), который поддерживает множе�?тво движков дл�? views.
...
Проверем CORS, при�?воив домен в заголовок `Origin`, отличный от `localhost`:
...
Вот �?пи�?ок middleware, вход�?щих в �?о�?тав фреймворка Fiber.
...
Спи�?ок модулей middleware, размещенных на внешнем хо�?тинге от [Fiber team](https://github.com/orgs/gofiber/people).
...
## 🌱 Middlewares от �?торонних разработчиков

Это �?пи�?ок middlewares, �?озданных �?ообще�?твом Fiber. Пожалуй�?та, [�?оздайте PR](https://github.com/gofiber/fiber/pulls), е�?ли хотите добавить в �?тот �?пи�?ок �?вой или изве�?тный вам middleware дл�? веб фреймворка Fiber!
...
Е�?ли вы хотите �?казать **�?па�?ибо** и/или поддержать активное развитие `Fiber`:
...
Fiber — �?то проект �? открытым и�?ходным кодом, который работает на пожертвовани�? дл�? оплаты �?четов, например, нашего доменного имени, GitBook, Netlify и serverless-хо�?тинга.

Е�?ли вы хотите поддержать, то ☕ [**купите чашку кофе**](https://buymeacoff.ee/fenny).

|                                                            | Пользователи                                     | Пожертвовани�? |
| :--------------------------------------------------------- | :----------------------------------------------- | :------------ |
