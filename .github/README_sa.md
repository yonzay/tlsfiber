...
يتم تن�?يذ هذه الاختبارات من قبل [TechEmpower](https://www.techempower.com/benchmarks/#section=data-r19&hw=ph&test=plaintext) و [Go Web](https://github.com/smallnest/go-web-framework-benchmark). إذا كنت تريد رؤية جميع النتائج ، يرجى زيارة موقعنا [Wiki](https://docs.gofiber.io/benchmarks).
...
ابدأ مشروعك بإنشاء مجلد ثم تشغيله `go mod init github.com/your/repo` ([أعر�? أكثر](https://blog.golang.org/using-go-modules)) 
داخل المجلد. ثم قم بتثبيت Fiber باستخدام مل�? [`go get`](https://golang.org/cmd/go/#hdr-Add_dependencies_to_current_module_and_install_them) أمر:
...
-   [ذاكرة منخ�?ضة](https://docs.gofiber.io/benchmarks)
...
-   وأكثر بكثير, [استكش�? Fiber](https://docs.gofiber.io/)

## 💡 �?لس�?ة

قو�?ر(مستخدمي لغة Go الجدد) جديد يجعل التبديل من [Node.js](https://nodejs.org/en/about/) الى [Go](https://golang.org/doc/)تتعامل مع منحنى التعلم قبل أن يتمكنوا من البدء �?ي بناءتطبيقات الويب . Fiber, كـ **إطار الويب**, تم إنشاؤه ب�?كرة **minimalism** ويتبع **UNIX way**, حتى يتمكن القو�?رون الجدد من دخول عالم Go بترحيب حار وموثوق.

Fiber هو **مستوحى** من Express, إطار الويب الأكثر شعبية على الإنترنت. قمنا بدمج **سهولة** الـ Express و **الأداء الخام** لـ Go. إذا كنت قد قمت بتطبيق تطبيق ويب �?ي Node.js (_using Express or similar_), ستظهر العديد من الأساليب والمبادئ **الاكثر شيوعاً** لك.

نحن **نصغي** لمستخدمينا [issues](https://github.com/gofiber/fiber/issues), نناقش [channel](https://gofiber.io/discord) _و�?ي جميع أنحاء الإنترنت_ لإنشاء **سريع**, **مرن** و **مألو�?** Go إطار الويب لـ **لأي** مهمة, **الموعد الأخير
** و تطوير **مهارات**! �?قط مثل Express ت�?عل لـ JavaScript عالم.

## 👀 أمثلة

�?يما يلي بعض الأمثلة الشائعة. إذا كنت ترغب �?ي رؤية المزيد من أمثلة التعليمات البرمجية, يرجى زيارة [Recipes repository](https://github.com/gofiber/recipes) او زيارة [API documentation](https://docs.gofiber.io).
...
1. اض�? [GitHub نجمة](https://github.com/gofiber/fiber/stargazers) للمشروع.
2. غرد عن المشروع [�?ي تويتر ](https://twitter.com/intent/tweet?text=Fiber%20is%20an%20Express%20inspired%20%23web%20%23framework%20built%20on%20top%20of%20Fasthttp%2C%20the%20fastest%20HTTP%20engine%20for%20%23Go.%20Designed%20to%20ease%20things%20up%20for%20%23fast%20development%20with%20zero%20memory%20allocation%20and%20%23performance%20in%20mind%20%F0%9F%9A%80%20https%3A%2F%2Fgithub.com%2Fgofiber%2Ffiber).
3. اكتب مراجعة أو برنامج تعليمي عن [Medium](https://medium.com/), [Dev.to](https://dev.to/) او �?ي موقعك الشخصي.
4. دعم المشروع بالتبرع بـ [كوب من القهوة](https://buymeacoff.ee/fenny).

## ☕ الداعمين

Fiber هو مشروع م�?توح المصدر يعمل على التبرعات لد�?ع ال�?واتير ، على سبيل المثال اسم النطاق الخاص بنا , gitbook, netlify and serverless الاستضا�?ة. إذا كنت تريد دعم Fiber, تستطيع ☕ [**شراء كوب قهوة هنا**](https://buymeacoff.ee/fenny).
