...
<p align="center">
  <b>Fiber</b>는 <a href="https://github.com/expressjs/express">Express</a>�?서 �?�?�?� 받고, <a href="https://golang.org/doc/">Go</a>를 위한 <b>가장 빠른</b> HTTP 엔진�?� <a ref="https://github.com/valyala/fasthttp">Fasthttp</a>를 토대로 만들어진 <b>웹 프레임워�?�</b> 입니다. <b>비 메모리 할당</b>과 <b>성능</b>�?� 고려한 <b>빠른</b> 개발�?� 위해 <b>�?쉽게</b> 사용�?��?��? 설계�?�었습니다.
</p>
...
�?� 테스트들�?� [TechEmpower](https://www.techempower.com/benchmarks/#section=data-r19&hw=ph&test=plaintext)와 [Go Web](https://github.com/smallnest/go-web-framework-benchmark)�?� 통해 측정�?�었습니다. 만약 모든 결과를 보고 싶다면, [Wiki](https://docs.gofiber.io/benchmarks)를 확�?�해 주세요.
...
-   견고한 [�?�우팅](https://docs.gofiber.io/routing)
-   [정�? 파�?�](https://docs.gofiber.io/application#static) 제공
-   뛰어난 [성능](https://docs.gofiber.io/benchmarks)
-   [�?�?� 메모리](https://docs.gofiber.io/benchmarks) 공간
-   [API 엔드�?��?�트](https://docs.gofiber.io/context)
-   미들웨어 & [Next](https://docs.gofiber.io/context#next) 지�?
-   [빠른](https://dev.to/koddr/welcome-to-fiber-an-express-js-styled-fastest-web-framework-written-with-on-golang-497) 서버 사�?�드 프로그래�?
-   [Template engines](https://github.com/gofiber/template)
-   [WebSocket support](https://github.com/gofiber/websocket)
-   [Rate Limiter](https://docs.gofiber.io/middleware#limiter)
-   Available in [15 languages](https://docs.gofiber.io/)
-   �?� 알고 싶다면, [Fiber 둘러보기](https://docs.gofiber.io/)

## 💡 철학

[Node.js](https://nodejs.org/en/about/)�?서 [Go](https://golang.org/doc/)로 전환하는 새로운 고�?�분들�?� 웹 어플리케�?�션�?�나 마�?��?�로 서비스 개발�?� 시작할 수 있게 �?�기 전�? 학습 곡선�? 시달리고 있습니다. Fiber는 **웹 프레임워�?�**로서, 새로운 고�?�분들�?� 따뜻하고 믿�?��?한 환�?�?� 가지고 빠르게 Go�?� 세�?�? 진입할 수 있게 **미니멀리즘**�?� 개�?과 **UNIX 방�?**�? 따�?� 개발�?�었습니다.

Fiber는 �?�터넷�?서 가장 �?�기있는 웹 프레임워�?��?� Express�?서 **�?�?�?� 받았습니다.** 우리는 Express�?� **쉬운** 사용과 Go�?� **성능**�?� 결합하였습니다. 만약 당신�?� Node.js (Express �?는 비슷한 것�?� 사용하여) 로 웹 어플리케�?�션�?� 개발한 경험�?� 있다면, 많�?� 메소드들과 �?리들�?� **매우 비슷하게** �?껴질 것 입니다.

우리는 **어떤한** 작업, **마�?�?�정**, 개발�?�?� **기술**�?��?�간�? **빠르고**, **유연하고**, **�?�숙한** Go 웹 프레임워�?�를 만들기 위해 사용�?들�?� [�?�슈들](https://github.com/gofiber/fiber/issues)�?�(그리고 모든 �?�터넷�?� 통해) **듣고 있습니다**! Express가 �?바스�?�립트 세계�?서 하는 것 처럼요.

## 👀 예제

다�?��?� �?�반�?�?� 예제들 입니다.

> �?� 많�?� 코드 예제를 보고 싶다면, [Recipes 저장소](https://github.com/gofiber/recipes) �?는 [API 문서](https://docs.gofiber.io)를 방문하세요.
...
`Fiber`�?� 활발한 개발�?� 지�?하고 �?사 �?�사를 하고 싶다면:

1. 프로�?트�? [GitHub Star](https://github.com/gofiber/fiber/stargazers)를 추가하세요.
2. [트위터�?서](https://twitter.com/intent/tweet?text=Fiber%20is%20an%20Express%20inspired%20%23web%20%23framework%20built%20on%20top%20of%20Fasthttp%2C%20the%20fastest%20HTTP%20engine%20for%20%23Go.%20Designed%20to%20ease%20things%20up%20for%20%23fast%20development%20with%20zero%20memory%20allocation%20and%20%23performance%20in%20mind%20%F0%9F%9A%80%20https%3A%2F%2Fgithub.com%2Fgofiber%2Ffiber) 프로�?트�? 대해 트윗하세요.
3. [Medium](https://medium.com/), [Dev.to](https://dev.to/) �?는 개�?� 블로그�? 리뷰 �?는 튜토리얼�?� 작성하세요.
