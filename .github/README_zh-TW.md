...
<p align="center">
  <b>Fiber</b>是移�?NodeJS的<a href="https://github.com/expressjs/express">Express</a><b>框架</b>改以<a href="https://golang.org/doc/">Go</a>語言編寫。<b>本套件基於</b><a href="https://github.com/valyala/fasthttp">Fasthttp</a>，Fasthttp有<b>�?分�?記憶體空間</b>和<b>Request Pool</b>的特性，在網路效能方�?�有著顯著的效能。
</p>
...
本測試使用[TechEmpower](https://www.techempower.com/benchmarks/#section=data-r19&hw=ph&test=plaintext)和[Go Web 框架效能測試](https://github.com/smallnest/go-web-framework-benchmark)。如果�?看全部的執行�?果，請到[Wiki](https://docs.gofiber.io/benchmarks) 。
...
-   [�?�態檔案](https://docs.gofiber.io/application#static)�?務
-   [超快速](https://docs.gofiber.io/benchmarks)
-   [佔用很少記憶體](https://docs.gofiber.io/benchmarks)
-   支�?� Express 的[API](https://docs.gofiber.io/context)
-   支�?�中介器和[下一步](https://docs.gofiber.io/context#next)
-   [立�?�上手](https://dev.to/koddr/welcome-to-fiber-an-express-js-styled-fastest-web-framework-written-with-on-golang-497)
-   [樣�?�引擎](https://github.com/gofiber/template)
-   支�?�[WebSocket](https://github.com/gofiber/websocket)
-   支�?�[�?速](https://docs.gofiber.io/middleware#limiter)
-   被翻譯�?[15]國語言(https://docs.gofiber.io/)
-   �?富的[文件](https://docs.gofiber.io/)

## 💡 �?�念

�?少[Node.js](https://nodejs.org/en/about/)的工程師跳到[Go](https://golang.org/doc/)必須學習一些知識，因此�?�了一個跟 Express 一樣的 Fiber �?這些麻煩。設計還是照原本的**極簡主義**還有�?�循**UNIX 慣例**，因此新手們�?�以**無痛**迅速進入 Go 的世界。

Fiber **�?�到** 網路上最�?行的 Web 框架 ExpressJS**啟發**，�?�?� Express 的**易用性**和 Go 的**高效能**。若你之�?用�?� Node.js 寫 Web 應用(_使用 ExpressJS/Koa 或類似工具_)，那你已經**上手**了。

有什麼�?題請發[issues](https://github.com/gofiber/fiber/issues)或加入 Discord [channel](https://gofiber.io/discord)討論，我們想�?創造**快速**�?**彈性**�?**�?�善**的社群給**任何人**使用�?就�? Express 那樣。

## 👀 範例

以下是一些常見範例。

> 更多程�?碼在[範例專案](https://github.com/gofiber/recipes)中或直接看[API 文件](https://docs.gofiber.io)。
...
當�?指定樣�?�引擎時 Fiber �?設用[html/template](https://golang.org/pkg/html/template/)。

如果你想�?執行部份或用別的樣�?�引擎[amber](https://github.com/eknkc/amber)�?[handlebars](https://github.com/aymerick/raymond)�?[mustache](https://github.com/cbroglie/mustache)�?[pug](https://github.com/Joker/jade)之類…請�?�考符�?�多樣�?�引擎的[樣�?�](https://github.com/gofiber/template)套件。
...
3. 在[Medium](https://medium.com/)�?[Dev.to](https://dev.to/)�?部�?�格上發表�?見或教學。
4. 贊助我們[一�?�咖啡](https://buymeacoff.ee/fenny)。

## ☕ 支�?者

Fiber 是一個以贊助維生的開�?專案，�?是: 網域�?gitbook�?netlify�?serverless 伺�?器。如果你想贊助也�?�以 ☕ [**買�?�咖啡**](https://buymeacoff.ee/fenny)
